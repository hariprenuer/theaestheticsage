...
def divisional_chart(jd_at_dob,place_as_tuple,ayanamsa_mode='Lahiri',divisional_chart_factor=1):
    ...
    ascendant_constellation, ascendant_longitude, _, _ = panchanga.ascendant(jd_at_dob,place_as_tuple)
    #print('ascendant rasi',ascendant_constellation,ascendant_longitude)
    #print(panchanga.dasavarga_from_long(ascendant_longitude,divisional_chart_factor))
    ...
    ascendant_divisional_chart_constellation=ascendant_constellation
...
if __name__ == "__main__":
    ...
    place = panchanga.Place('salem',lat,lon,tz)
    jd = utils.julian_day_number(dob,tob)
    planet_dhasamsa = divisional_chart(jd, place,divisional_chart_factor=1)
